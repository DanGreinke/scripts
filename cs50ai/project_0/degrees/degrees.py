...
def shortest_path(source, target):
    ...
    while True:
        # if nothing in frontier, there's no path
        # should be frontier.empty, but this evaluated to true for some reason
